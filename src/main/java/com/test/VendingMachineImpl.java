...
import com.test.exceptions.NotFullPaidException;
import com.test.exceptions.NotSufficientChangeException;
import com.test.exceptions.SoldOutException;
...
public class VendingMachineImpl implements VendingMachine {
    ...
    private Item collectItem() throws NotSufficientChangeException, NotFullPaidException {
        if(isFullPaid()){
            if(hasSufficientChange()){
                itemInventory.deduct(currentItem); return currentItem;
            }
    ...
    private boolean hasSufficientChangeForAmount(long amount){
        boolean hasChange = true; try{ getChange(amount);
        }catch(NotSufficientChangeException nsce){
            return hasChange = false; } return hasChange;
    }
